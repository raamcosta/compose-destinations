...
const val NAV_TYPE_SERIALIZER_CUSTOM_SERIALIZER = "$CORE_PACKAGE_NAME.navargs.custom.CustomTypeSerializer"
...
const val CORE_STRING_NAV_TYPE = "DestinationsStringNavType"
