...
const val NAV_GRAPH_DEFAULT_START_ARGS_PLACEHOLDER = "@NAV_GRAPH_DEFAULT_START_ARGS_PLACEHOLDER@"
...
const val INNER_IMPORTED_ROUTES = "@INNER_IMPORTED_ROUTES@"
...
const val NAV_GRAPH_START_TYPED_ROUTE_TYPE = "@NAV_GRAPH_START_TYPED_ROUTE_TYPE@"
 ...
 */
${REQUIRE_OPT_IN_ANNOTATIONS_PLACEHOLDER}$NAV_GRAPH_VISIBILITY_PLACEHOLDER data object $NAV_GRAPH_NAME_PLACEHOLDER : BaseRoute(), $NAV_GRAPH_TYPE {
    
    override val startRoute: $NAV_GRAPH_START_TYPED_ROUTE_TYPE = $NAV_GRAPH_START_ROUTE_PLACEHOLDER$NAV_GRAPH_DEFAULT_START_ARGS_PLACEHOLDER
...
$NAV_GRAPH_ROUTE_PLACEHOLDER$NAV_GRAPH_INVOKE_FUNCTION$NAV_GRAPH_ARGS_FROM$NAV_GRAPH_ARGUMENTS_PLACEHOLDER$NAV_GRAPH_DEEP_LINKS_PLACEHOLDER$INNER_IMPORTED_ROUTES
}
