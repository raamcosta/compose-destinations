...
const val NAV_TYPE_REGISTRY_CALL = "@NAV_TYPE_REGISTRY_CALL@"
...
${REQUIRE_OPT_IN_ANNOTATIONS_PLACEHOLDER}$NAV_GRAPH_VISIBILITY_PLACEHOLDER data object $NAV_GRAPH_NAME_PLACEHOLDER : BaseRoute(), $NAV_GRAPH_TYPE {
    ...
    override val startRoute: $NAV_GRAPH_START_TYPED_ROUTE_TYPE = $NAV_GRAPH_START_ROUTE_PLACEHOLDER
...
$NAV_GRAPH_ROUTE_PLACEHOLDER$NAV_GRAPH_INVOKE_FUNCTION$NAV_GRAPH_ARGS_FROM$NAV_GRAPH_ARGUMENTS_PLACEHOLDER$NAV_GRAPH_DEEP_LINKS_PLACEHOLDER$INNER_IMPORTED_ROUTES$NAV_TYPE_REGISTRY_CALL
}
