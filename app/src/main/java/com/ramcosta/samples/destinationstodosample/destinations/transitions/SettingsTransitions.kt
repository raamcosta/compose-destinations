...
import com.ramcosta.samples.destinationstodosample.destinations.SETTINGS_ROUTE

@ExperimentalAnimationApi
@DestinationTransitions(SETTINGS_ROUTE)
object SettingsTransitions: DestinationTransitionsSpec {
